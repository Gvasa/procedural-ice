...
# Libs and Frameworks:
ifeq ($(UNAME), Linux)
	FRAMEWORKS = -lGLEW -lglfw3 -lGL -lX11 -lXi -lXrandr -lXxf86vm -lXinerama -lXcursor -lrt -lm -pthread -ldl -lnanogui -std=c++11
else
...
compile: $(FILES)
	$(CC) $(CFLAGS) $(FILES) -w -o $(BINFOLD)$(BINNAME) $(LIBFOLD) $(INCFOLD) $(FRAMEWORKS)
.PHONY: compile
